...
<input type="month" className='px-3 py-2 text-sm rounded-lg disabled:bg-gray-100' value={experience.end_date || ""} onChange={(e)=>updateExperience(index,"end_date",e.target.value)} disabled={experience.is_current} />
</div>
...
<Sparkles className='w-3 h-3' />
  ...
  <textarea rows={4} value={experience.description || ""} onChange={(e)=>updateExperience(index,"description",e.target.value)} className='w-full text-sm px-3 py-2 rounded-lg resize-none' placeholder='Describe your key responsibilites and achievements...'/>
