...
import ProfessionSummary from '../Components/ProfessionSummary'
...
const saveResume = async () => {
  try {
    ...
    // Agar new image upload hui hai to backend JSON ke andar image field mat bhejo
...
Back to Dashboard
  ...
  onChange={(newTemplate) => setResumeData(prev => ({ ...prev, template: newTemplate }))}
/>
    ...
    <PersonalInfoForm data={resumeData.personal_info} onchange={(data)=>setResumeData(prev=>({...prev,personal_info:data}))} removeBackground={removeBackground} setRemoveBackground={setRemoveBackground}/>
      ...
      {activeSection.id==='summary' && (
       <ProfessionSummary data={resumeData.professional_summary} onChange={(data)=>setResumeData(prev=>({...prev,professional_summary:data}))} setResumeData={setResumeData}/>
      )
     }
